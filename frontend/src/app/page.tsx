  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-bg relative overflow-hidden">
      ...
      <nav className="fixed top-0 inset-x-0 z-50 px-6 py-4">
        <div className="max-w-7xl mx-auto glass-pill px-6 py-3 flex items-center justify-between shadow-2xl">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center">
              <Brain className="w-4 h-4 text-white" />
            </div>
            <span className="font-heading font-bold text-lg tracking-tight text-white">EduQuiz</span>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link 
              href="/register" 
              className="text-sm font-semibold bg-white text-bg px-5 py-2 rounded-full hover:scale-105 transition-transform"
            >
              Get Started
            </Link>
          </div>
