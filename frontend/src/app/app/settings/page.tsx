            ...
            <form onSubmit={handleSave} className="space-y-8">
                ...
                <div className="flex-1 space-y-5 w-full">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      className="input-glass bg-[#0F0F2D] border-white/5 w-full"
                    />
                  </div>
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      disabled
                      value={user?.email || ''}
                      className="input-glass bg-[#0F0F2D] border-white/5 opacity-60 cursor-not-allowed w-full"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-5 pt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-semibold text-[slate-400] uppercase tracking-wider block">School / University</label>
                    <input
                      type="text"
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-semibold text-[slate-400] uppercase tracking-wider block">Department / Faculty</label>
                    <input
                      type="text"
                  ...
                  <div className="flex flex-col gap-1.5 md:col-span-2 lg:col-span-1">
                    <label className="text-xs font-semibold text-[slate-400] uppercase tracking-wider block">Class Level</label>
                    <input
                      type="text"
              ...
              <div className="space-y-5 pt-4">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-[slate-400] uppercase tracking-wider block">Preferred Subjects</label>
                  <input
                    type="text"
